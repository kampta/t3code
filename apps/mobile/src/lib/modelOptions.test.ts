...
describe("mobile model options", () => {
  ...
  it("does not treat a non-Codex driver in the default Codex slot as preferred", () => {
    const claude = {
      selection: { instanceId: ProviderInstanceId.make("codex"), model: "claude-default" },
      isDefault: true,
      isLegacy: false,
    ...
    const codex = {
      selection: { instanceId: ProviderInstanceId.make("codex_work"), model: "gpt-default" },
      isDefault: true,
      isLegacy: false,
      isProviderReady: true,
    ...
    expect(resolveDefaultModelSelection([claude, codex])).toBe(codex.selection);
  });
